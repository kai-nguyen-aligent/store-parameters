...
store-parameters/0.0.0 linux-x64 node-v20.16.0
...
# Commands
<!-- commands -->
* [`store-parameters hello PERSON`](#store-parameters-hello-person)
* [`store-parameters hello world`](#store-parameters-hello-world)
...
## `store-parameters hello PERSON`

Say hello

```
USAGE
  $ store-parameters hello PERSON -f <value>
...
EXAMPLES
  $ store-parameters hello friend --from oclif
  hello friend from oclif! (./src/commands/hello/index.ts)
```

_See code: [src/commands/hello/index.ts](https://github.com/kai-nguyen-aligent/store-parameters/blob/v0.0.0/src/commands/hello/index.ts)_

## `store-parameters hello world`
...
_See code: [src/commands/hello/world.ts](https://github.com/kai-nguyen-aligent/store-parameters/blob/v0.0.0/src/commands/hello/world.ts)_
